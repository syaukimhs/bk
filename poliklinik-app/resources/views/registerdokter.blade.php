...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Register sebagai dokter</p>

      <form action="/registerdokters" method="post">
        @csrf
      ...
      <p class="mb-0">
        <a href="/logindokter" class="text-center">i already have an account</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
