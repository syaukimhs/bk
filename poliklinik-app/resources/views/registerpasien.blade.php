...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Pasien</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Register sebagai pasien</p>

      <form action="/registerpasiens" method="post">
        @csrf
        ...
        <!-- <div class="input-group mb-3"> 
          <input type="password" class="form-control" name="alamat" placeholder="alamat">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
        ...
        <div class="input-group mb-3">
          <input type="number" class="form-control" name="ho_hp" placeholder="no hp">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <p class="mb-0">
        <a href="/loginpasien" class="text-center">i already have an account</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
